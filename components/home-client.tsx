...
export default function HomeClient({
  ...
  // Format the hero title with line breaks
  const heroTitleLines = homeSettings.heroTitle.split("\n").map((line: string, i: number) => (
    <React.Fragment key={i}>
      {line}
      {i < homeSettings.heroTitle.split("\n").length - 1 && <br />}
    </React.Fragment>
  ))
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 w-full">
              <div className="flex flex-col justify-center">
                ...
                >
                  <p className="text-lg mb-8 max-w-md">{homeSettings.heroDescription}</p>
                </motion.div>
              </div>
        ...
        <section className="py-20 border-t border-b rounded-section">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div className="space-y-0">
              {homeSettings.services.map((item: any, index: number) => (
                <motion.div
                  key={index}
                  className="relative"
                  variants={fadeIn}
                ...
                >
                  <div className="flex items-center justify-between py-6 border-t border-gray-200 group">
                    <div className="flex items-center gap-8">
                      <span className="text-[#fb4e4e] text-xl font-medium">{item.number}</span>
              ...
              {caseStudies.slice(0, 3).map((study: any, index: number) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      href={`/experiments/${study._sys.filename}`}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Link
                        href={`/journal/${entry._sys.filename}`}
                        className="flex items-center text-sm hover:text-[#fb4e4e]"
                      >
