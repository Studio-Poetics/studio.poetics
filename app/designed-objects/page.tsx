...
// Designed Objects Data
const designedObjects = [
  {
    title: "Ceramic Vessel No. 3",
    slug: "ceramic-vessel-3",
    category: "ceramic",
    description: "Hand-crafted ceramic vessel with subtle texture variations that catch and reflect light.",
  ...
  },
  {
    ...
    category: "wood",
    description: "Minimalist wooden trays in various sizes, hand-finished with natural oil to enhance grain patterns.",
  ...
  {
    title: "Cotton Textile Collection",
    slug: "cotton-textile-collection",
    category: "textile",
    description: "Set of hand-dyed cotton textiles in natural, subtle tones with varying weave structures.",
    image: "/placeholder.svg?key=4osbe",
  },
  {
    title: "Porcelain Tea Set",
    slug: "porcelain-tea-set",
    category: "ceramic",
    description: "Minimalist porcelain tea set with subtle variations in glaze and form.",
    image: "/placeholder.svg?key=kxmdw",
  },
  {
    title: "Maple Wood Stool",
    slug: "maple-wood-stool",
    category: "wood",
    description: "Hand-carved maple stool with organic form inspired by natural erosion patterns.",
    image: "/placeholder.svg?height=800&width=800&query=minimal wooden stool",
  },
  {
    title: "Blown Glass Vessels",
    slug: "blown-glass-vessels",
    category: "glass",
    description: "Collection of hand-blown glass vessels in subtle gradient colors with organic forms.",
    image: "/placeholder.svg?height=800&width=800&query=minimal blown glass vessels",
  },
]
