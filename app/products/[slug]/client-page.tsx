...
export default function ProductDetailClient({ product, slug }: ProductProps) {
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {product.relatedProducts.map((slug, index) => {
            const relatedProduct = product.relatedProductsData[slug]
            return (
